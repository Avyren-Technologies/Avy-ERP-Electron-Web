import { Wrench, CalendarCheck, AlertTriangle, Package, FileSpreadsheet, Cpu, Clock } from "lucide-react";

const PLANNED_FEATURES = [
    { icon: CalendarCheck, label: "Preventive Maintenance", desc: "Schedule and track time-based and usage-based preventive maintenance plans" },
    { icon: AlertTriangle, label: "Breakdown Tracking", desc: "Log and manage unplanned equipment breakdowns with root cause analysis" },
    { icon: Package, label: "Spare Parts", desc: "Spare parts inventory with min-stock alerts and consumption tracking" },
    { icon: FileSpreadsheet, label: "Maintenance Work Orders", desc: "Create, assign, and close maintenance work orders with labour and parts tracking" },
    { icon: Cpu, label: "Machine Registry", desc: "Centralised equipment master with specifications, documents, and maintenance history" },
];
            ...
            <div className="mb-8">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-neutral-500 dark:text-neutral-400">Equipment maintenance and asset care</p>
                    </div>
                </div>
            </div>
