// ============================================================
// Tenant Onboarding — Constants & Config Data
// Web + Electron
// ============================================================
...
export const STEP_META = [
    ...
    { id: 2, title: 'Statutory & Tax', subtitle: 'PAN, TAN, GSTIN, PF/ESI/PT', icon: '📋' },
    { id: 3, title: 'Address', subtitle: 'Registered & corporate address', icon: '📍' },
...
export const COMPANY_STATUSES = [
    { value: 'Draft', label: 'Draft', subtitle: 'Setup still in progress', color: 'warning' },
    { value: 'Pilot', label: 'Pilot', subtitle: 'Trial / UAT phase with limited users', color: 'info' },
    { value: 'Active', label: 'Active', subtitle: 'Company is live — full production use', color: 'success' },
    { value: 'Inactive', label: 'Inactive', subtitle: 'Suspended or decommissioned', color: 'danger' },
];
...
export const MODULE_CATALOGUE = [
    ...
    },
    {
        ...
        name: 'Masters',
        icon: '📋',
        description: 'Item master, shift master, machine master, operation & part master',
        price: 499,
        dependencies: [],
    },
];
...
export function resolveModuleDependencies(
    selectedIds: string[],
    catalogue: typeof MODULE_CATALOGUE
): { resolved: string[]; auto: string[] } {
