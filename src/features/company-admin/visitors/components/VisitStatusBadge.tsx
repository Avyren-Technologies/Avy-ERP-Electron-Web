...
// Only the keys defined in Prisma `VisitStatus` belong here. Non-existent
// enum values like PRE_REGISTERED, OVERSTAY, APPROVED and PENDING_APPROVAL
// previously sat in this table — they are derived state (approvalStatus or
// overstay flag) and are rendered separately. Keeping this badge strictly
// aligned with the schema enum prevents fallback rendering on bad input.
...
const APPROVAL_CONFIG: Record<string, { label: string; color: string; bg: string }> = {
    PENDING: { label: "Pending Approval", color: "text-warning-700 dark:text-warning-400", bg: "bg-warning-50 dark:bg-warning-900/20 border-warning-200 dark:border-warning-800/50" },
    ...
    AUTO_APPROVED: { label: "Auto-Approved", color: "text-primary-700 dark:text-primary-400", bg: "bg-primary-50 dark:bg-primary-900/20 border-primary-200 dark:border-primary-800/50" },
    REJECTED: { label: "Rejected", color: "text-danger-700 dark:text-danger-400", bg: "bg-danger-50 dark:bg-danger-900/20 border-danger-200 dark:border-danger-800/50" },
};
