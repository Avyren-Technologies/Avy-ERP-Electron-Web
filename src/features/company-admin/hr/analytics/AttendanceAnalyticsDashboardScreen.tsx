...
export function AttendanceAnalyticsDashboardScreen() {
  ...
  return (
    <DashboardShell
      ...
      headerSubtitle="Track attendance consistency, late trends, and workforce coverage in real time."
      headerAside={(
      ...
      {dashboardData?.heatmap && (
        <div>
          <div className="flex items-center gap-2.5 mb-4">
            ...
            <h2 className="text-sm font-bold text-neutral-800 dark:text-neutral-100">Department Heatmap</h2>
          </div>
          <HeatmapChart
