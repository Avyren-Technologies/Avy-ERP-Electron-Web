...
export const offboardingKeys = {
    ...
    // Exit Requests
    exitRequests: (params?: { page?: number; limit?: number; status?: string; separationType?: string }) =>
    ...
    // F&F Settlements
    fnfSettlements: (params?: { page?: number; limit?: number; status?: string }) =>
...
export function useExitRequests(params?: { page?: number; limit?: number; status?: string; separationType?: string }) {
    return useQuery({
...
export function useFnFSettlements(params?: { page?: number; limit?: number; status?: string }) {
    return useQuery({
