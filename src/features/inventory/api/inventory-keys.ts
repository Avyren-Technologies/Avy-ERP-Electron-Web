export const inventoryKeys = {
    ...
    // Masters
    warehouses: (params?: Record<string, unknown>) => params
    ...
    reasonCodes: (params?: Record<string, unknown>) => params
    ...
    approvalHistory: (params?: Record<string, unknown>) => params
    ...
    activitySummary: (params?: Record<string, unknown>) => params
        ? [...inventoryKeys.all, 'activity-summary', params] as const
        : [...inventoryKeys.all, 'activity-summary'] as const,

    // Production
    issueToProduction: (params?: Record<string, unknown>) => params
    ...
    fgReceipts: (params?: Record<string, unknown>) => params
    ...
    wipStock: (params?: Record<string, unknown>) => params
        ? [...inventoryKeys.all, 'wip-stock', params] as const
        : [...inventoryKeys.all, 'wip-stock'] as const,
    scrapAnalysis: (params?: Record<string, unknown>) => params
        ? [...inventoryKeys.all, 'scrap-analysis', params] as const
        : [...inventoryKeys.all, 'scrap-analysis'] as const,

    // Putaway Rules
    putawayRules: (params?: Record<string, unknown>) => params
        ? [...inventoryKeys.all, 'putaway-rules', params] as const
        : [...inventoryKeys.all, 'putaway-rules'] as const,

    // Pallets
    pallets: (params?: Record<string, unknown>) => params
    ...
    // Staging
    stagingInbound: (params?: Record<string, unknown>) => params
        ? [...inventoryKeys.all, 'staging-inbound', params] as const
        : [...inventoryKeys.all, 'staging-inbound'] as const,
    stagingOutbound: (params?: Record<string, unknown>) => params
    ...
    // Tool Life Policies
    toolLifePolicies: (params?: Record<string, unknown>) => params
    ...
    // Tool at Machine
    toolsAtMachine: (params?: Record<string, unknown>) => params
        ? [...inventoryKeys.all, 'tools-at-machine', params] as const
        : [...inventoryKeys.all, 'tools-at-machine'] as const,

    // Reconditioning
    reconditioning: (params?: Record<string, unknown>) => params
    ...
    complianceDocuments: (params?: Record<string, unknown>) => params
    ...
    // Analytics
    dailyAnalytics: (params?: Record<string, unknown>) => params
        ? [...inventoryKeys.all, 'daily-analytics', params] as const
        : [...inventoryKeys.all, 'daily-analytics'] as const,
    kpiSnapshots: (params?: Record<string, unknown>) => params
    ...
    // Saved Filters
    savedFilters: (params?: Record<string, unknown>) => params
