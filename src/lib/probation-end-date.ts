...
/** Read probation length from designation API shape (master uses `probationDays`). */
...
/** Add whole calendar months to an ISO date (yyyy-MM-dd). */
...
/**
 * Same rules as backend: designation probation days first, else grade probation months.
 */
